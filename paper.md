...
We organise the package into 14 capability groups, which `src/qis/api.py` names.

The backtester is 427 lines, and that follows from the design assumption rather than from
