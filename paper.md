...
The public interface is `qis.__all__`, which holds 445 names; `src/qis/api.py` records that list as a
literal together with a documented core of 138 symbols grouped by capability, and the suite fails
