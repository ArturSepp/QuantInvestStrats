"""
Risk/return scatter for a US bond-ETF universe.

Pulls 11 bond ETFs (SHV through EMB), computes annualised vol and
p.a. return via ``get_ra_perf_columns``, and renders the
vol-vs-return scatter as a stylised efficient-frontier view.
"""
...
prices = yf.download(tickers, start="2003-12-31", end=None, ignore_tz=True, auto_adjust=True)['Close'][tickers].rename(bond_etfs, axis=1)
