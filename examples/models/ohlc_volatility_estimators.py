"""
OHLC realised-volatility estimators on high-frequency intraday bars.

Demonstrates ``qis.estimate_hf_ohlc_vol`` with the full set of
``OhlcEstimatorType`` variants (Parkinson, Garman-Klass, Rogers-Satchell,
Yang-Zhang) on yfinance intraday bars at multiple intervals (1d down to 1m).
"""
import numpy as np
import pandas as pd
