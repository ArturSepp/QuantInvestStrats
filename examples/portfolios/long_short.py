"""
Backtest a long IEF / short LQD pair (Treasury duration vs IG credit).

Demonstrates a simple two-leg long/short portfolio via
``qis.backtest_model_portfolio`` with daily rebalancing, plus a
benchmark-adjusted risk/return view.
"""
# packages
import pandas as pd
