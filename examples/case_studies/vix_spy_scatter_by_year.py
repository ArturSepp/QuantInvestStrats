"""
Scatter changes in VIX (or ATM implied vol) against underlying SPY returns,
split by year.

For each year, plots ΔVIX vs SPY return with a regression line per year,
to visualise how the equity-vol leverage relationship has evolved across
regimes.
"""
# packages
import pandas as pd
...
if __name__ == '__main__':
    ...
    run_local(local=Locals.VIX_SPY)
