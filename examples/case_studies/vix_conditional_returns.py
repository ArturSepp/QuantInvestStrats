"""
Conditional returns on the front-month short-VIX strategy (SPVXSPI),
given different predictors: VIX level, realised vol, and the VIX-vs-RV
spread.

Uses ``df_boxplot_by_classification_var`` to render conditional return
distributions by predictor quantile. Bloomberg.
"""
