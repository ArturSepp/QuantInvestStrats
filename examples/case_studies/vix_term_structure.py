"""
VIX term-structure correlation with SPX returns.

Pulls the full VIX tenor curve (VIX1D, VIX9D, VIX, VIX3M, VIX6M, VIX1Y)
alongside SPX, computes the correlation matrix of changes in VIX tenors
vs SPX returns via ``compute_masked_covar_corr``, and renders a heatmap
plus tenor-by-tenor scatter regressions. Bloomberg.
"""
import pandas as pd
