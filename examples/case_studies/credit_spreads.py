"""
Credit-spread time series and beta to equity / rates.

Pulls AAA, A, BAA, HY 10Y option-adjusted spreads alongside SPX and
UST10y, then scatter-plots spread changes against benchmark returns to
visualise the rate / equity beta of credit spreads. Bloomberg.
"""
import pandas as pd
import numpy as np
