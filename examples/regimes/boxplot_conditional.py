"""
Conditional return boxplots by regime via
``qis.df_boxplot_by_classification_var``.

Splits weekly SPY returns by VIX regime quantile and renders boxplots
so the conditional distributions are visible side by side.
"""
# packages
import pandas as pd
