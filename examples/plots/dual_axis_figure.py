"""
Build a dual-axis time-series plot using ``qis.plot_time_series_2ax``.

Generates synthetic NAV / cumulative-volume series, plots NAV on the
left axis and a volume series on the right with shared x-axis
formatting, and saves the multi-asset output to PDF.
"""
import numpy as np
import pandas as pd
