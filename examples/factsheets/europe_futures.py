"""
Strategy factsheet on a volume-weighted basket of European equity futures.

Pulls CAC, DAX, IBEX, MIB front-month futures from Bloomberg, builds
quarterly volume-weighted weights via ``df_to_weight_allocation_sum1``,
and runs ``qis.generate_strategy_factsheet``. Bloomberg.
"""
import pandas as pd
