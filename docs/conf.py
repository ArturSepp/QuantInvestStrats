...
API_HEADER = """..
   Generated by docs/conf.py from the qis export list and qis/api.py. Do not edit by hand.

API reference
=============

Public means exported from ``qis/__init__.py``. This page is regenerated on every build, so it
...
it. ``qis/tests/test_core_api.py`` enforces that. **Also exported** lists everything else that
