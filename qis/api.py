...
PUBLIC_API: Tuple[str, ...] = (
    ...
    'ReturnsTransform', 'RollingPerfStat', 'SD_PERF_COLUMNS', 'STANDARD_TABLE_COLUMNS',
    ...
    'TRE_TABLE_COLUMNS', 'TimePeriod', 'TrainLivePeriod', 'TrainLiveSamples', 'TrendLine',
    'ValueType', 'add_bnb_regime_shadows', 'adjust_component_navs_to_portfolio',
    'adjust_returns_with_ar', 'adjust_returns_with_factor_lag',
    'adjust_returns_with_joint_unsmoothing', 'append_df_to_feather', 'append_time_series',
    'apply_pca', 'assert_list_subset', 'backtest_model_portfolio', 'backtest_rebalanced_portfolio',
    ...
    'compute_excess_return_navs', 'compute_excess_returns', 'compute_futures_fx_adjusted_returns',
    'compute_fx_optimal_hedge', 'compute_fx_vol_beta', 'compute_ic_timeseries',
    ...
    'compute_portfolio_independent_var_by_ac', 'compute_portfolio_risk_contributions',
    'compute_portfolio_var_np', 'compute_portfolio_vol', 'compute_ra_perf_table',
    'compute_ra_perf_table_with_benchmark', 'compute_ra_returns', 'compute_regime_avg',
    'compute_regimes_pa_perf_table_from_sampled_returns', 'compute_returns_dict',
    'compute_returns_transform', 'compute_risk_table', 'compute_roll_mean',
    ...
    'generate_rebalancing_indicators', 'generate_strategy_benchmark_active_perf_plt',
    ...
    'plot_contour', 'plot_corr_matrix_from_covar', 'plot_data_timeseries', 'plot_desc_freq_table',
    'plot_df_table', 'plot_df_table_with_ci', 'plot_errorbar',
    'plot_exposures_strategy_vs_benchmark_stack', 'plot_heatmap', 'plot_histogram',
    'plot_histplot2d', 'plot_line', 'plot_lines_list', 'plot_multi_asset_fx_hedging_report',
