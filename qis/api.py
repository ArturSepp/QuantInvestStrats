...
PUBLIC_API: Tuple[str, ...] = (
    ...
    'StrategySignalData', 'TRE_TABLE_COLUMNS', 'TimePeriod', 'TrainLivePeriod', 'TrainLiveSamples',
    ...
    'compute_ic_timeseries', 'compute_info_ratio_table', 'compute_local_and_fx_return',
    'compute_masked_covar_corr', 'compute_max_current_drawdown', 'compute_mean_freq_regimes',
