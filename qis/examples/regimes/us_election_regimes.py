"""
Returns conditional on US political regimes (divided vs unified government).

Builds a year-to-government-type table from the 1968–present US election
results, classifies returns by regime, and renders before/after-election
performance comparisons across asset classes. Bloomberg.
"""
import numpy as np
import pandas as pd
