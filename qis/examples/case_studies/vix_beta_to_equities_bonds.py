"""
Rolling beta of a long-VIX ETF (VXX) to SPY and TLT, plus regime-
conditional analysis.

Wraps the VXX series in ``PortfolioData`` and uses
``BenchmarkReturnsQuantilesRegime`` to attribute realised performance
across SPY return regimes.
"""
import pandas as pd
