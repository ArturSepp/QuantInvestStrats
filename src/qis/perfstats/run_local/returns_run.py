...
def run_local(local: Locals):
    ...
    if local == Locals.TO_ZERO_NONNAN:
    ...
    elif local == Locals.VOL_SAMPLE:
        vols = compute_sampled_vols(prices=prices,
                                    freq_return='B',
                                    freq_vol='ME')
        print(vols)

    elif local == Locals.ADJUST_PORTFOLIO_PA_RETURNS:
    ...
    elif local == Locals.QUARTERLY_RETURNS:
    ...
    elif local == Locals.TO_RETURNS_HOLIDAY_NAN:
    ...
    elif local == Locals.TO_RETURNS_MIXED_FREQUENCIES:
    ...
    elif local == Locals.TOTAL_RETURN_TRAILING_NAN:
    ...
    elif local == Locals.PRICES_AT_FREQ_FFILL_NANS_OFF:
    ...
    elif local == Locals.EXCESS_RETURNS_LAG:
    ...
    elif local == Locals.PRICE_FFILL_BETWEEN_NANS_METHOD:
    ...
    elif local == Locals.PA_RETURN_ZEROS_SHAPE:
    ...
    elif local == Locals.ZERO_FIRST_NONNAN_BOTH_BRANCHES:
...
if __name__ == '__main__':
    ...
    run_local(local=Locals.QUARTERLY_RETURNS)
