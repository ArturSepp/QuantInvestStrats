...
def run_local(local: Locals):
    ...
    if local == Locals.DATES:
    ...
    elif local == Locals.SAMPLE_DATES_IDX:
    ...
    elif local == Locals.PERIOD_WITH_HOLIDAYS:
    ...
    elif local == Locals.EOD_FREQ_HOUR:
        ...
        print(rebalancing_schedule[rebalancing_schedule])

    elif local == Locals.FIXED_MATURITY_ROLLS:
    ...
    elif local == Locals.TIMEPERIOD_INDEXER:
    ...
    elif local == Locals.FIND_UPTO_DATE:
        time_period = TimePeriod('31Dec2023', '31Dec2024')
        times_q = generate_dates_schedule(time_period=time_period, freq='QE')
    ...
    elif local == Locals.REBALANCING_FROM_FREQS:
        time_period = TimePeriod('31Dec2023', '31Dec2024')
...
if __name__ == '__main__':
    ...
    run_local(local=Locals.REBALANCING_FROM_FREQS)
