...
def run_local(local: Locals):
    ...
    elif local == Locals.REINDEX_UPTO_LAST_NONAN:
    ...
    elif local == Locals.MERGE_DFS_ON_COLUMNS:
    ...
    elif local == Locals.NONNAN_INDEX:
        # Create test data
...
if __name__ == '__main__':
    ...
    run_local(local=Locals.NONNAN_INDEX)
