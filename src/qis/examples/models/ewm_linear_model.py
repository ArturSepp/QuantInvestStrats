"""
Time-varying multivariate factor loadings via ``qis.EwmLinearModel``.

Fits monthly GLD returns on (SPY, TLT) with EWMA-weighted least squares
(span=12), accounting for cross-correlation between regressors, and
plots the resulting time-varying betas.
"""
