"""
Decompose close-to-close returns into overnight + intraday components.

For a given ticker, separates the gap return (close[t-1] -> open[t])
from the intraday return (open[t] -> close[t]) and plots them alongside
the close-to-close series. Useful for studying when equity risk premium
is realised within the trading day.
"""
import pandas as pd
