"""
Rolling correlations between a crypto asset (BTC) and an equity asset (QQQ).

Computes 3m, 6m, and 12m rolling correlations of daily returns and
plots the joint time series — showing how the BTC/QQQ relationship has
evolved across regimes.
"""
import pandas as pd
import numpy as np
