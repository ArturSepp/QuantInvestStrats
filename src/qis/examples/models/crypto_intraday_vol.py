"""
EWMA volatility on hourly BTC data — handling 24/7 crypto markets.

Pulls 1y of hourly BTC-USD bars via yfinance, shifts timestamps from
bar-start to bar-end, then computes ``compute_ewm_vol`` to illustrate
that crypto vol estimation needs no weekend filter unlike equities.
"""
import numpy as np
import pandas as pd
