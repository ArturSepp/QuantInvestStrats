"""
Sharpe-vs-Sortino across return sampling frequencies.

For a multi-ETF universe, computes both ratios at four frequencies
(B, W-WED, ME, QE) using ``get_ra_perf_columns`` and plots them as
annotated scatters to show how the relationship shifts with the
sampling horizon.
"""
# imports
