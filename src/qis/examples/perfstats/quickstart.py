"""
Minimum-viable qis usage — the snippets shown in the package README.

Pulls a multi-ETF universe via yfinance and walks through
``plot_prices``, ``plot_prices_with_dd``, ``plot_ra_perf_table``, and
``plot_ra_perf_table_benchmark`` with annotation/styling defaults.
"""
# imports
