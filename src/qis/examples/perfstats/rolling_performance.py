"""
Rolling per-annum returns via ``qis.compute_rolling_perf_stat``.

Computes 5y and 10y rolling p.a. returns on the S&P 500 total-return
index and overlays the 10y breakeven inflation rate using
``plot_time_series_2ax``. Bloomberg.
"""
# packages
