"""
Show the impact of adding a 2% BTC sleeve to a 60/40 portfolio.

Backtests two portfolios — pure 60/40 SPY/IEF and 59/39/2 with BTC
funded equally from each leg — and renders a price + drawdown plot
and risk-adjusted performance table benchmarked to the unmodified 60/40.
"""
import pandas as pd
