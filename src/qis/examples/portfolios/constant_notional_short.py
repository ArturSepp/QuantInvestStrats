"""
Constant-notional vs constant-weight short SPY, illustrating the path
dependence of constant-leverage rebalancing.

Companion to https://twitter.com/ArturSepp/status/1614551490093359104.
Builds a constant-notional short and a constant-weight short, plots
P&L paths and a returns scatter to show the convexity drag.
"""
