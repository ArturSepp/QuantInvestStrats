"""
Backtest the canonical 60/40 SPY/IEF balanced portfolio with and
without a 2% management fee, via ``qis.backtest_model_portfolio``
with quarterly rebalancing. Renders price + drawdown via
``plot_prices_with_dd``.
"""
import pandas as pd
