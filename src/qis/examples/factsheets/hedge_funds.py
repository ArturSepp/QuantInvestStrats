"""
Multi-asset factsheet on the HFRX / HFRI / NEIXCTA hedge-fund index family.

Builds 50/50 HFRXGL/CTA and 50/50 HFRIFWI/CTA blends via
``qis.backtest_model_portfolio``, concatenates them with the SG-CTA
benchmark, and renders a multi-asset factsheet. Bloomberg.
"""
# packages
import pandas as pd
