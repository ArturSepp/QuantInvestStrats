"""
Multi-asset factsheet template for arbitrary Bloomberg ticker lists.

The ``run_report`` function contains a number of preset ticker dicts
(volatility carry, rates vol, CTA / hedge-fund families, credit, CDS) —
uncomment one and run to produce a multi-asset factsheet via
