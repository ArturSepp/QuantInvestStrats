"""
Bull / bear / normal regime Sharpe attribution.

Classifies quarterly SPY returns into three regimes via
``BenchmarkReturnsQuantilesRegime``, then renders a price plot with
regime shadows and a regime-conditional Sharpe scatter across the
universe (TLT/LQD/HYG/GLD).
"""
