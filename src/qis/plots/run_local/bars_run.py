...
def run_local(local: Locals):
    ...
    elif local == Locals.TOP_BOTTOM_RETURNS:
    ...
    elif local == Locals.VBAR_WEIGHTS:
    ...
    elif local == Locals.MONTHLY_RETURNS_BARS:
        from qis.run_local.price_data_run import load_etf_data
        import qis.perfstats.returns as ret
...
if __name__ == '__main__':
    ...
    run_local(local=Locals.VBAR_WEIGHTS)
