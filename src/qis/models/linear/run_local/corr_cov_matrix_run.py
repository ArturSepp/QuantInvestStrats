"""Development runner extracted from ``qis.models.linear.tests.corr_cov_matrix_test``."""
...
def run_local(local: Locals):
    ...
    elif local == Locals.EWMA_CORR_MATRIX:
    ...
    elif local == Locals.PLOT_CORR_MATRIX:
    ...
    elif local == Locals.MATRIX_REGULARIZATION:
...
if __name__ == "__main__":
    run_local(local=Locals.MATRIX_REGULARIZATION)
