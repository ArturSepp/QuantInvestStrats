...
PUBLIC_API: Tuple[str, ...] = (
    ...
    'PerfParams', 'PerfStat', 'PerfStatsLabels', 'PortfolioData', 'PortfolioInput',
    'RA_TABLE_COLUMNS', 'RA_TABLE_COMPACT_COLUMNS', 'RegimeClassifier', 'RegimeData',
    'ReplacementType', 'ReportingFrequency', 'ReturnTypes', 'ReturnsTransform', 'RiskModel',
    'RollingPerfStat', 'SD_PERF_COLUMNS', 'STANDARD_TABLE_COLUMNS', 'SharpeConvention',
    'SignalAggType', 'SignalDiagnosticsColumns', 'SignalDiagnosticsResult', 'SignalMapType',
    'SmartDiversificationReport', 'SnapshotPeriod', 'StrategySignalData', 'TimePeriod',
    'TrendLine', 'ValueType', 'WEIGHT_TOL', 'add_bnb_regime_shadows',
