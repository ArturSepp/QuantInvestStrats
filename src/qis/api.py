...
PUBLIC_API: Tuple[str, ...] = (
    ...
    'FULL_TABLE_COLUMNS', 'FactorScenarioProjection', 'FactorSensitivityResult', 'FactorsData',
    ...
    'LinearModel', 'MeanAdjType', 'ModelFeatureAlphaBetaAttribution',
    ...
    'MultiAssetsReport', 'MultiPortfolioData', 'NanBackfill', 'OutlierPolicy', 'PdfType',
    'PerfParams', 'PerfStat', 'PerfStatsLabels', 'PortfolioBreadthResult', 'PortfolioData',
    'PortfolioInput', 'RA_TABLE_COLUMNS', 'RA_TABLE_COMPACT_COLUMNS', 'RegimeClassifier',
    'RegimeData', 'ReplacementType', 'ReportingFrequency', 'ReturnTypes', 'ReturnsTransform',
    'RiskModel', 'RollingPerfStat', 'SD_PERF_COLUMNS', 'STANDARD_TABLE_COLUMNS',
    'SharpeConvention', 'SignalAggType', 'SignalDiagnosticsColumns', 'SignalDiagnosticsResult',
    'SignalMapType', 'SmartDiversificationReport', 'SnapshotPeriod', 'StrategySignalData',
    'TimePeriod', 'TrendLine', 'TurnoverComputationType', 'ValueType', 'WEIGHT_TOL',
    'add_bnb_regime_shadows', 'adjust_component_navs_to_portfolio', 'adjust_returns_with_ar',
    ...
    'plot_brinson_totals_table', 'plot_classification_scatter', 'plot_clusters', 'plot_contour',
    'plot_corr_matrix_from_covar', 'plot_data_timeseries', 'plot_dendrogram',
    'plot_desc_freq_table', 'plot_df_table', 'plot_df_table_with_ci', 'plot_errorbar',
    'plot_exposures_strategy_vs_benchmark_stack', 'plot_heatmap', 'plot_histogram',
    'plot_histplot2d', 'plot_line', 'plot_lines_list', 'plot_model_layer_ewma_return_bridge',
    'plot_model_layer_ewma_sharpe_bridge', 'plot_model_layer_in_sample_sharpe_bridge',
    'plot_model_layer_rolling_ewma_regression_alpha', 'plot_multi_asset_fx_hedging_report',
    'plot_multivariate_scatter_with_prediction', 'plot_periodic_returns_table', 'plot_pie',
    'plot_portfolio_breadth_concentration', 'plot_portfolio_breadth_current_comparison',
    'plot_portfolio_breadth_history', 'plot_price_history', 'plot_prices', 'plot_prices_2ax',
    'plot_prices_with_dd', 'plot_prices_with_fundamentals', 'plot_qq', 'plot_quantile_class_table',
    ...
    'return_log_shock', 'returns_to_nav', 'run_asset_fx_hedging_report', 'save_df_dict_to_csv',
    'save_df_dict_to_excel', 'save_df_dict_to_feather', 'save_df_dict_to_parquet',
    'save_df_to_csv', 'save_df_to_excel', 'save_df_to_feather', 'save_df_to_parquet', 'save_fig',
    'save_figs', 'save_figs_to_pdf', 'series_nansum_weighted', 'set_group_loadings',
    'set_suptitle', 'split_df_by_groups', 'timer', 'to_finite_reciprocal', 'to_flat_list',
    'to_portfolio_returns', 'to_quarterly_returns', 'to_returns', 'to_total_returns',
    'to_zero_first_nonnan_returns', 'truncate_prior_to_start', 'unsmooth_returns_ar1_ewma',
    'unsmooth_returns_glm', 'update_df_in_csv', 'update_kwargs', 'utils',
