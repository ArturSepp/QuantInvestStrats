...
PUBLIC_API: Tuple[str, ...] = (
    ...
    'compute_model_layer_ewma_regression_attribution', 'compute_model_layer_ewma_stage_sharpes',
    'compute_multi_asset_fx_hedging', 'compute_net_navs_ex_perf_man_fees',
    'compute_net_return_ex_perf_man_fees', 'compute_num_years', 'compute_one_factor_ewm_betas',
    'compute_pa_excess_compounded_returns', 'compute_pa_return', 'compute_path_autocorr',
    'compute_path_autocorr_given_lags', 'compute_path_corr', 'compute_path_lagged_corr',
    'compute_path_lagged_corr_given_lags', 'compute_pca_r2', 'compute_per_asset_betas',
