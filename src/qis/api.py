...
PUBLIC_API: Tuple[str, ...] = (
    ...
    'ColVar', 'ColumnData', 'ConditionalScenarioBand', 'ConvolutionType', 'CorrMatrixOutput',
    'CrossXyType', 'DdLegendType', 'DescTableType', 'EXTENDED_TABLE_COLUMNS', 'EnumMap',
    'EwmLinearModel', 'EwmaAlphaBetaHacResult', 'FACTSHEET_CONFIG_DAILY_DATA_LONG_PERIOD',
    'FACTSHEET_CONFIG_DAILY_DATA_SHORT_PERIOD', 'FACTSHEET_CONFIG_MONTHLY_DATA_LONG_PERIOD',
    'FACTSHEET_CONFIG_MONTHLY_DATA_SHORT_PERIOD', 'FACTSHEET_CONFIG_QUARTERLY_DATA_LONG_PERIOD',
    'FULL_TABLE_COLUMNS', 'FactorGroupSpec', 'FactorScenarioProjection', 'FactorSensitivityResult',
    ...
    'PdfType', 'PerfParams', 'PerfStat', 'PerfStatsLabels', 'PortfolioBreadthResult',
    'PortfolioData', 'PortfolioHolding', 'PortfolioInput', 'PortfolioStressResult',
    'PortfolioValuationResult', 'RA_TABLE_COLUMNS', 'RA_TABLE_COMPACT_COLUMNS', 'RegimeClassifier',
    'RegimeData', 'ReplacementType', 'ReportingFrequency', 'ResponseBasis', 'ReturnTypes',
    'ReturnsTransform', 'RiskModel', 'RollingPerfStat', 'SD_PERF_COLUMNS',
    'STANDARD_TABLE_COLUMNS', 'ScenarioMode', 'SharpeConvention', 'ShockConvention',
    'SignalAggType', 'SignalDiagnosticsColumns', 'SignalDiagnosticsResult', 'SignalMapType',
    'SmartDiversificationReport', 'SnapshotPeriod', 'StrategySignalData', 'StressReportArtifacts',
    'StressReportConfig', 'StressScenarios', 'StressTestConfig', 'TimePeriod', 'TrendLine',
    'TurnoverComputationType', 'Underlying', 'ValueType', 'WEIGHT_TOL', 'add_bnb_regime_shadows',
    'adjust_component_navs_to_portfolio', 'adjust_returns_with_ar',
    'adjust_returns_with_factor_lag', 'adjust_returns_with_joint_unsmoothing',
    'align_weights_to_columns', 'append_df_to_feather', 'append_time_series', 'apply_pca',
    'assert_list_subset', 'backtest_model_portfolio', 'backtest_rebalanced_portfolio',
    'bfill_timeseries', 'bootstrap_ar_process', 'bootstrap_data', 'bootstrap_price_data',
    'bootstrap_price_fundamental_data', 'check_df_for_duplicated_columns_index',
    'compute_ar1_unsmoothed_prices', 'compute_ar_residuals', 'compute_ar_unsmoothed_prices',
    'compute_asset_returns_dict', 'compute_autocorr_df', 'compute_autocorrelation_at_int_periods',
    'compute_avg_max_dd', 'compute_benchmark_portfolio_risk_contributions',
    ...
    'compute_brinson_attribution_table', 'compute_cash_fx_adjusted_returns',
    'compute_conditional_scenario_band', 'compute_data_pca_r2', 'compute_desc_freq_table',
    'compute_desc_table', 'compute_drawdowns_stats_table', 'compute_eigen_portfolio_weights',
    'compute_ewm', 'compute_ewm_alpha_r2_given_prediction', 'compute_ewm_beta_alpha_forecast',
    'compute_ewm_corr_df', 'compute_ewm_corr_single', 'compute_ewm_covar',
    'compute_ewm_covar_newey_west', 'compute_ewm_covar_tensor',
    ...
    'compute_factor_sensitivity', 'compute_futures_fx_adjusted_returns',
    'compute_fx_optimal_hedge', 'compute_fx_vol_beta',
    ...
    'compute_max_current_drawdown', 'compute_mean_freq_regimes',
    'compute_model_feature_alpha_beta_attribution', 'compute_model_layer_alpha_beta_attribution',
    ...
    'compute_model_layer_ewma_sharpe_contributions', 'compute_model_layer_ewma_stage_sharpes',
    'compute_model_layer_in_sample_sharpe_contributions',
    'compute_model_layer_rolling_ewma_regression_alpha', 'compute_multi_asset_fx_hedging',
    ...
    'compute_portfolio_benchmark_ewm_beta_alpha_attribution', 'compute_portfolio_breadth',
    ...
    'compute_te_ir_errors', 'compute_total_return', 'compute_turnover',
    'conditional_factor_covariance', 'conditional_factor_shock', 'corr_to_pivot_row',
    'covar_to_corr', 'create_overlay_portfolio_curve', 'create_rebalancing_indicators_from_freqs',
    ...
    'duration_log_shock', 'estimate_acf_from_path', 'estimate_acf_from_paths',
    'estimate_dimson_beta', 'estimate_ewm_factor_model', 'estimate_ewma_alpha_beta_hac',
    'estimate_ic_ir', 'estimate_rolling_ewma_covar', 'estimate_signal_diagnostics', 'estimate_vol',
    ...
    'generate_multi_portfolio_factsheet', 'generate_portfolio_stress_report',
    'generate_price_history_report', 'generate_rebalancing_indicators',
    'generate_static_weights_schedule', 'generate_strategy_benchmark_active_perf_plt',
    'generate_strategy_benchmark_factsheet_plt', 'generate_strategy_factsheet',
    'generate_strategy_signal_factsheet_by_instrument', 'generate_weight_change_report',
    'get_aligned_fx_spots', 'get_all_folder_files', 'get_annualisation_conversion_factor',
    'get_annualization_factor', 'get_excess_returns_nav', 'get_group_dict', 'get_local_file_path',
    'get_nonnan_index', 'get_output_path', 'get_paired_rareturns_signals', 'get_paths',
    'get_pdf_path', 'get_ra_perf_columns', 'get_resource_path', 'get_time_period',
    'get_time_period_label', 'get_time_period_shifted_by_years', 'get_time_to_maturity',
    'get_ytd_time_period', 'idx_to_alphabet', 'implied_leverage',
    'infer_annualisation_factor_from_df', 'interpolate_infrequent_returns', 'join_file_name_parts',
    'lever_returns', 'limit_weights_to_max_var_limit', 'load_df_dict_from_csv',
    'load_df_dict_from_excel', 'load_df_dict_from_feather', 'load_df_dict_from_parquet',
    'load_df_from_csv', 'load_df_from_excel', 'load_df_from_feather', 'load_df_from_parquet',
    'load_fx_rates_data', 'local_path', 'log_returns_to_nav', 'long_short_to_relative_nav',
    'map_signal_to_weight', 'market_data', 'matrix_regularization', 'melt_scatter_data_with_xvar',
    'models', 'mult_df_columns_with_vector', 'np_array_to_df_columns', 'np_array_to_df_index',
    'perfstats', 'plot_bars', 'plot_best_worst_returns', 'plot_box',
    'plot_brinson_attribution_table', 'plot_brinson_totals_table', 'plot_classification_scatter',
    'plot_clusters', 'plot_contour', 'plot_corr_matrix_from_covar', 'plot_data_timeseries',
    'plot_dendrogram', 'plot_desc_freq_table', 'plot_df_table', 'plot_df_table_with_ci',
    'plot_errorbar', 'plot_exposures_strategy_vs_benchmark_stack', 'plot_heatmap',
    'plot_histogram', 'plot_histplot2d', 'plot_line', 'plot_lines_list',
    'plot_model_layer_ewma_return_bridge', 'plot_model_layer_ewma_sharpe_bridge',
    'plot_model_layer_in_sample_sharpe_bridge', 'plot_model_layer_rolling_ewma_regression_alpha',
    'plot_multi_asset_fx_hedging_report', 'plot_multivariate_scatter_with_prediction',
    'plot_periodic_returns_table', 'plot_pie', 'plot_portfolio_breadth_concentration',
    'plot_portfolio_breadth_current_comparison', 'plot_portfolio_breadth_history',
    'plot_price_history', 'plot_prices', 'plot_prices_2ax', 'plot_prices_with_dd',
    'plot_prices_with_fundamentals', 'plot_qq', 'plot_quantile_class_table',
    'plot_ra_perf_annual_matrix', 'plot_ra_perf_bars', 'plot_ra_perf_by_dates',
    'plot_ra_perf_scatter', 'plot_ra_perf_table', 'plot_ra_perf_table_benchmark',
    'plot_regime_boxplot', 'plot_regime_data', 'plot_regime_pdf',
    ...
    'portfolio_navs_to_additive', 'portfolio_returns_to_nav', 'price_target_log_shock',
    'prices_at_freq', 'prices_to_scaled_nav', 'project_factor_scenarios', 'qis',
    'return_log_shock', 'returns_to_nav', 'run_asset_fx_hedging_report',
    'run_portfolio_stress_test', 'save_df_dict_to_csv', 'save_df_dict_to_excel',
    'save_df_dict_to_feather', 'save_df_dict_to_parquet', 'save_df_to_csv', 'save_df_to_excel',
    'save_df_to_feather', 'save_df_to_parquet', 'save_fig', 'save_figs', 'save_figs_to_pdf',
    'series_nansum_weighted', 'set_group_loadings', 'set_suptitle', 'split_df_by_groups', 'timer',
    'to_finite_reciprocal', 'to_flat_list', 'to_portfolio_returns', 'to_quarterly_returns',
    'to_returns', 'to_total_returns', 'to_zero_first_nonnan_returns', 'truncate_prior_to_start',
...
CORE_API: Dict[str, Tuple[str, ...]] = {
    'Instrument portfolio stress': (
        'FactorGroupSpec', 'HoldingPayoff', 'InstrumentLeg', 'InstrumentPortfolio',
        'InstrumentType', 'KinkPolicy', 'PayoffContext', 'PortfolioHolding',
        'PortfolioStressResult', 'PortfolioValuationResult', 'ResponseBasis',
        'ScenarioMode', 'ShockConvention', 'StressScenarios', 'StressTestConfig',
        'Underlying', 'run_portfolio_stress_test',
    ...
    'Performance statistics': (
        ...
        'estimate_ic_ir', 'estimate_signal_diagnostics', 'TurnoverComputationType',
        'compute_turnover',
    ),
    'Portfolio and backtesting': (
        ...
        'compute_ewma_realised_tracking_error', 'PortfolioBreadthResult',
    ...
    'EWM estimation': (
        ...
        'estimate_rolling_ewma_covar', 'plot_corr_matrix_from_covar',
    ),
    ...
    'Plots': (
        ...
        'set_suptitle', 'plot_portfolio_breadth_history',
        'plot_portfolio_breadth_current_comparison', 'plot_portfolio_breadth_concentration',
    ),
